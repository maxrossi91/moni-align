/* seqidx2liftidx - Builds the sequence index for the reference
...
*/
/*!
   \file seqidx2liftidx.cpp
   \brief seqidx2liftidx.cpp Builds the sequence index for the reference.
...
int main(int argc, char *const argv[])
{
  ...
  seqidx sidx;
  std::string filename_idx = args.filename + sidx.get_file_extension();
